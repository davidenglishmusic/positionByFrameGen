...
describe PositionByFrameGen do
  ...
  describe 'get_all_frame_coordinates' do
    it 'returns an array of each frame and its coordinates when the starting coordinates are [0,0] and the end coordinates are [10,10]' do
    ...
    it 'returns an array of each frame and its coordinates when the starting coordinates are [2,7] and the end coordinates are [-8,-1]' do
    ...
    it 'returns an array of each frame and its coordinates when the starting coordinates are [0,0] and the end coordinates are [0,-10]' do
    ...
    it 'returns an array of each frame and its coordinates when the starting coordinates are [0,0] and the end coordinates are [0,0]' do
    ...
    it 'returns an array of each frame and its coordinates when the starting coordinates are [-3,3] and the end coordinates are [3,3]' do
    ...
    it 'returns an array of each frame and its coordinates when the starting coordinates are [-3,-3] and the end coordinates are [3,1]' do
    ...
    it 'returns an array of each frame and its coordinates when the starting coordinates are [3,2] and the end coordinates are [3,3]' do
    ...
    it 'returns an array of each frame and its coordinates when the starting coordinates are [3,3] and the end coordinates are [3,2]' do
